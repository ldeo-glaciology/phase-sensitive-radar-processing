function cfg = fmcw_process_config_vsr_Ronne(filename2)
...
% Default config
cfg.notes = 'vsr_Ronne config file';

% Use test data
cfg.useTestFiles = 0;
home = '/Users/elizabeth/Google Drive/home_research/projects/ApRES/data/Ronne_ApRES_KN/Site5cApRESdata 3/';
cfg.filename1 = [home 'DATA2015-01-10-1448.DAT'];
cfg.filename2 = [home filename2];
