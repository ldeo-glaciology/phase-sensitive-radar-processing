...
% (cell array) or 'last', which will plot the same files as last time
%
...
%   is in standard Matlab format eg [3:7] or [1:4,8].
%
% 'maxrange' (or 'mr'), followed by maximum depth to plot to, in m (default = 2000).
%
...
%% Settings
maxbursts = 100; % per file
maxchirps = 1000; % per burst
maxrangedefault = 2000; % default range to crop data to (m)
p = 2; % padfactor;
