function cfg = fmcw_process_config_default
...
cfg.maxDepthConfig = 420;
cfg.bedMethod = 'maxAmp'; % 'ampThresh' 'maxAmp' 'xcor' ???
cfg.ampThreshdB = -80; % dB - minimum bed strength
cfg.bedSearchRange = [80 inf]; % bed search range (m)

% Bulk lag matching (co-registration)
cfg.doBulkAllignment = 1; %
cfg.bulkAlignRange = [60 100];
...
cfg.maxStrain = 0.02; % maximum strain magnitude to search for
